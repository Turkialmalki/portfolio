...
import { PROJECTS, localizeProject, type ProjectData } from "@/data/projects";
import { useLanguage } from "@/i18n/LanguageProvider";

const COPY = {
  ar: {
    pill: "الأعمال",
    heading: "تجارب مصنوعة بعناية",
    sub: "مبادرات هندسية ومنتجات رقمية سُلّمت بهدف واضح — في المصارف والتقنية المالية والقطاع الحكومي ومنظومات الابتكار.",
    all: "الكل",
    loadMore: "عرض المزيد",
    showLess: "عرض أقل",
  ...
  en: {
    pill: "Portfolio",
    heading: "Crafted Experiences",
    sub: "Engineering initiatives and digital products delivered with purpose — across banking, fintech, government, and innovation ecosystems.",
    all: "All",
    loadMore: "Load More",
    showLess: "Show Less",
...
/** Drawn arrow: the "→" character has no glyph in Thmanyah Sans. */
  ...
  return (
    <>
      ...
      <style>{`
        ...
        [dir="rtl"] .pf-cta-arrow,
        [dir="rtl"] .pf-arrow-badge svg { transform: scaleX(-1); }
        ...
        [dir="rtl"] .pf-card:hover .pf-cta-arrow {
...
function ProjectsList() {
  ...
  /* Localised once, then everything downstream — filters included — reads the
     display language rather than the English source. */
  ...
  const filters = useMemo(
    () => Array.from(new Set(projects.map(industryKey))),
    [projects],
  );
      ...
      <section className="pf-list">
        ...
        {hasMore && (
          <div className="pf-more">
            ...
            >
              {showAll ? copy.showLess : copy.loadMore}
            </button>
          </div>
        )}
      </section>
        ...
        <div className="pf-info">
          ...
          <div className="pf-foot">
            <span className="pf-cta">
              {copy.viewCase}
              <ArrowGlyph className="pf-cta-arrow" />
            </span>
